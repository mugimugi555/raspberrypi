...
cp ~/tensorflow_src/tensorflow/lite/python/metrics_interface.py ./tflite_runtime/
cp ~/tensorflow_src/tensorflow/lite/python/metrics_portable.py ./tflite_runtime/
